...
class TestRemoteEnvironmentWithSlurm:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ("BOOT_FAIL", (False, False, False)),
            ("CANCELLED", (True, True, True)),
            ("CANCELLED by 123456", (True, True, True)),
            ("COMPLETED", (True, True, False)),
            ("COMPLETING", (True, False, False)),
            ("CONFIGURING", (True, False, False)),
            ("DEADLINE", (True, True, True)),
            ("EXPEDITING", (False, False, False)),
            ("FAILED", (True, True, True)),
            ("LAUNCH_FAILED", (True, True, True)),
            ("NODE_FAIL", (True, True, True)),
            ("OUT_OF_MEMORY", (True, True, True)),
            ("PENDING", (False, False, False)),
            ("POWER_UP_NODE", (True, False, False)),
            ("PREEMPTED", (False, False, False)),
            ("RECONFIG_FAIL", (True, True, True)),
            ("REQUEUED", (False, False, False)),
            ("REQUEUE_FED", (False, False, False)),
            ("REQUEUE_HOLD", (False, False, False)),
            ("RESIZING", (False, False, False)),
            ("RESV_DEL_HOLD", (False, False, False)),
            ("REVOKED", (False, False, False)),
            ("RUNNING", (True, False, False)),
            ("SIGNALING", (True, False, False)),
            ("SPECIAL_EXIT", (False, False, False)),
            ("STAGE_OUT", (True, False, False)),
